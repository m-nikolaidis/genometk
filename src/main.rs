...
fn cli() -> Command {
    let cmd = Command::new("genometk")
        ...
        .subcommand(
            ...
            .arg(arg!(-slen <seqlen> "The length of the sequences").required(true).value_parser(clap::value_parser!(i64)))
            .arg(arg!(-snum <num_sequences> "The number of the final sequences").required(true).value_parser(clap::value_parser!(i64)))
        ...
        .subcommand(
            Command::new("sample")
                ...
                .arg(arg!(-i <input> "Input fasta file").required(true))
                .arg(arg!(-o <output> "The Output file").required(true))
                .arg(arg!(--num_sequences <num> "The number of the final sequences").required(false).value_parser(clap::value_parser!(usize)))
                .arg(arg!(--list_file <list_file> "A file with the list of sequences to keep").required(false).value_parser(clap::value_parser!(String)))
